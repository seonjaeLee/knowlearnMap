...
function NotebookDetail() {
    ...
    // --- State: LLM / sLLM Studio Config ---
    const [llmMode, setLlmMode] = useState('LLM');
    const [llmTemperature, setLlmTemperature] = useState('0.7');
    const [sllmModels, setSllmModels] = useState([]);
    const [selectedSllmCode, setSelectedSllmCode] = useState('');
        ...
        (async () => {
            try {
                ...
                if (Array.isArray(list) && list.length > 0) {
                    setSllmModels(list);
                    setSelectedSllmCode(list[0].code);
                } else {
                    setSllmModels([]);
                    setSelectedSllmCode('');
                }
