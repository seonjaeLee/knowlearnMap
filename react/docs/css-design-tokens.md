...
> **현행 SSOT:** [`kl-ui-guide.md`](./kl-ui-guide.md) Part 2 · `src/assets/styles/tokens/`.
...
| `src/assets/styles/km-scrollbar-thin.css` | 콘텐츠 내부 얇은 스크롤 — **`textarea` 전역** · 클래스 **`km-scrollbar-thin`** · `--km-scrollbar-*`(`index.css`) |
