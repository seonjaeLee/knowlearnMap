...
- [../foundation/design-tokens.md](../foundation/design-tokens.md)
...
| 문서 | 내용 |
|------|------|
| [../foundation/layout-guideline.md](../foundation/layout-guideline.md) | 화면 여백, 브레이크포인트, 제목 단계 느낌 |
| [../foundation/design-tokens.md](../foundation/design-tokens.md) | 색·간격 이름 규칙 (`--spacing-*`, `--radius-*` 등) |
| [../README.md](../README.md) | 폼·버튼·모달을 정리할 때 큰 그림 |
...
행 높이·글자 크기·헤더 스타일을 프로젝트 토큰과 맞추려면 [../table/data-table-spec.md](../table/data-table-spec.md)를 함께 참고합니다.
