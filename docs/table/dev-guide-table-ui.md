...
- [../surface/list-page-spec.md](../surface/list-page-spec.md) — 표 **위** PageHeader·툴바·검색
- [data-table-spec.md](./data-table-spec.md)
- [../foundation/layout-guideline.md](../foundation/layout-guideline.md)
- **MUI 공통 표·푸터·페이지네이션**: 아래 **섹션 6** (`BasicTable` 스택)
- 열 너비 드래그(원시 `<table>`): 아래 **§5**, 구현체 `src/hooks/useResizableColumns.jsx`

---

팀 내 실수 방지용 요약입니다. 상세 규격은 [data-table-spec.md](./data-table-spec.md), 토큰은 [../foundation/design-tokens.md](../foundation/design-tokens.md)를 따른다.
...
6. 토큰·스크롤바는 [../foundation/design-tokens.md](../foundation/design-tokens.md), `kl-scrollbar-thin` 규칙을 따른다.
