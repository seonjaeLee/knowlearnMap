# Modal Migration Plan (1차 · 아카이브)

> **2026-05-19:** 1차 모달 인프라 계획 보존용. 신규 UI 이관은 [../governance/migration-policy.md](../governance/migration-policy.md) · [modal-spec.md](./modal-spec.md)를 따릅니다.
...
- [ ] `docs/history/ui-history2.md` — **담당자가 요청할 때만** 갱신(`.cursor/rules/ui-history-on-request.mdc`); 자동 반영 체크 항목 아님
