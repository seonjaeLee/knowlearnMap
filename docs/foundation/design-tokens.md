...
| `docs/foundation/design-tokens.md` | 본 문서 — **규칙·표** |
| [../history/ui-history2.md](../history/ui-history2.md) | UI 변경 **현행** 이력 (**갱신은 요청 시만** — `.cursor/rules/ui-history-on-request.mdc`) |
| [../history/ui-history.md](../history/ui-history.md) | UI 이력 아카이브 |
