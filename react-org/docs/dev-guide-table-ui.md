...
> **현행 SSOT:** [`kl-ui-guide.md`](./kl-ui-guide.md) Part 7·8 · `src/assets/styles/kit/kl-basic-table.css`.
...
- **대안**: `aria-label` 또는 시각적으로 숨긴 텍스트. 프로젝트 공통은 [km-table-icon-actions.css](../src/assets/styles/km-table-icon-actions.css) 패턴 참고.
